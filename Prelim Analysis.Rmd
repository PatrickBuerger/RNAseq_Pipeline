...
genes_sign_SS8_Intercept <- decideTests(fit.cont1_host) %>% as.data.frame() %>%  bind_cols(fit.cont1_host$genes)
...
genes_sign_WT10_Intercept <- decideTests(fit.cont2_host) %>% as.data.frame() %>%  bind_cols(fit.cont2_host$genes)
...
genes_sign_SS3_Intercept <- decideTests(fit.cont3_host) %>% as.data.frame() %>%  bind_cols(fit.cont3_host$genes)
...
genes_sign_SS5_Intercept <- decideTests(fit.cont4_host) %>% as.data.frame() %>%  bind_cols(fit.cont4_host$genes)
...
any_DE_genes_host <- decideTests(fit.cont1_host, lfc=0.5) %>% 
  as.data.frame() %>% 
...
fit.cont2host_photo <- topTable(fit.cont1_host, number = Inf, p.value = 0.05) %>% filter(Annotation %>% str_detect("[R|r]ibulose|[P|p]hoto|[F|f]ucox|[C|c]aroteno"))
fit.cont2host_photo
...
heatmap.data <- fit.cont1host_TopSign
#
...
host_SS8_intercept_VS_all <- topTable(fit.cont1host, n=Inf) %>% write.table(, file="host_SS8_intercept_VS_all_topTable.csv", sep="\t", quote=F)

# Specific pairwise comparisons. What separates SS8 from respective strains?
library(openxlsx)
SampleGroup<-"Pairwise-Host-SS8_VS_respec_strains"
Title <- paste(SampleGroup,"DGE-Table")
FileName <- paste(Title,".xlsx")
limma.resA <- topTable(fit.cont1host,coef="SS8.vs.WT10",sort.by="p",n="Inf")
limma.resB <- topTable(fit.cont1host,coef="SS8.vs.SS3",sort.by="p",n="Inf")
limma.resC <- topTable(fit.cont1host,coef="SS8.vs.SS3",sort.by="p",n="Inf")
...
# Gerneral adaptations of respective strains. Take this table for GO analysis with MWU/Fisher script. 
host_WT10_intercept_VS_all <- topTable(fit.cont2host, n=Inf) %>% write.table(, file="host_WT10_intercept_VS_all_topTable.csv", sep="\t", quote=F)

# USE THESE FOR INDIVIDUAL GENE COMPARISONS IN REVIGO
host_strains_8_up_VS_WT10 <- filter(genes_sign_WT10_Intercept, StrainStrain3 == 0 | StrainStrain3 == -1, StrainStrain5 == 0 | StrainStrain5 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
host_strains_8_down_VS_WT10 <- filter(genes_sign_WT10_Intercept, StrainStrain3 == 0 | StrainStrain3 == 1, StrainStrain5 == 0 | StrainStrain5 == 1, StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
host_strains_8_ALL_VS_WT10 <- filter(genes_sign_WT10_Intercept, StrainStrain8 == 1 | StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
write.xlsx(host_strains_8_up_VS_WT10, file="SS8_host_DGE_expression_list.xlsx", sheetName="SS_8_vs_WT10_unique_up", append=TRUE, row.names=FALSE)
#
write.xlsx(host_strains_8_down_VS_WT10, file="SS8_host_DGE_expression_list.xlsx", sheetName="SS_8_vs_WT10_unique_down", append=TRUE, row.names=FALSE)  
#
write.xlsx(host_strains_8_ALL_VS_WT10, file="SS8_host_DGE_expression_list.xlsx", sheetName="host_strains_8_ALL_VS_WT10", append=TRUE, row.names=FALSE) 
...
# Gerneral adaptations of respective strains. Take this table for GO analysis with MWU/Fisher script. 
host_SS3_intercept_VS_all <- topTable(fit.cont3host, n=Inf) %>% write.table(, file="host_SS3_intercept_VS_all_topTable.csv", sep="\t", quote=F)

host_strains_8_up_VS_SS3 <- filter(genes_sign_SS3_Intercept, StrainStrain10 == 0 | StrainStrain10 == -1, StrainStrain5 == 0 | StrainStrain5 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
host_strains_8_down_VS_SS3 <- filter(genes_sign_SS3_Intercept, StrainStrain10 == 0 | StrainStrain10 == 1, StrainStrain5 == 0 | StrainStrain5 == 1, StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
host_strains_8_ALL_VS_SS3 <- filter(genes_sign_SS3_Intercept, StrainStrain8 == 1 | StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
write.xlsx(host_strains_8_up_VS_SS3, file="SS8_host_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS3_unique_up", append=TRUE, row.names=FALSE)
#
write.xlsx(host_strains_8_down_VS_SS3, file="SS8_host_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS3_unique_down", append=TRUE, row.names=FALSE)  
#
write.xlsx(host_strains_8_ALL_VS_SS3, file="SS8_host_DGE_expression_list.xlsx", sheetName="host_strains_8_ALL_VS_SS3", append=TRUE, row.names=FALSE)  




# Gerneral adaptations of respective strains. Take this table for GO analysis with MWU/Fisher script. 
host_SS5_intercept_VS_all <- topTable(fit.cont4host, n=Inf) %>% write.table(, file="host_SS5_intercept_VS_all_topTable.csv", sep="\t", quote=F)

host_strains_8_up_VS_SS5 <- filter(genes_sign_SS5_Intercept, StrainStrain10 == 0 | StrainStrain10 == -1, StrainStrain3 == 0 | StrainStrain3 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
host_strains_8_up_VS_SS5 <- filter(genes_sign_SS5_Intercept, StrainStrain10 == 0 | StrainStrain10 == -1, StrainStrain3 == 0 | StrainStrain3 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
host_strains_8_ALL_VS_SS5 <- filter(genes_sign_SS5_Intercept, StrainStrain8 == 1 | StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
write.xlsx(host_strains_8_up_VS_SS5, file="SS8_host_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS5_unique_up", append=TRUE, row.names=FALSE)
#
write.xlsx(host_strains_8_down_VS_SS5, file="SS8_host_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS5_unique_down", append=TRUE, row.names=FALSE)
#
write.xlsx(host_strains_8_ALL_VS_SS5, file="SS8_host_DGE_expression_list.xlsx", sheetName="host_strains_8_ALL_VS_SS5", append=TRUE, row.names=FALSE)
...
genes_sign_SS8_Intercept <- decideTests(fit.cont1_symbiont) %>% as.data.frame() %>%  bind_cols(fit.cont1_symbiont$genes)
...
genes_sign_WT10_Intercept <- decideTests(fit.cont2_symbiont) %>% as.data.frame() %>%  bind_cols(fit.cont2_symbiont$genes)
...
genes_sign_SS3_Intercept <- decideTests(fit.cont3_symbiont) %>% as.data.frame() %>%  bind_cols(fit.cont3_symbiont$genes)
...
genes_sign_SS5_Intercept <- decideTests(fit.cont4_symbiont) %>% as.data.frame() %>%  bind_cols(fit.cont4_symbiont$genes)
...
# Photosynthesis associated genes
fit.cont2symbiont_ammonium <- topTable(fit.cont1_symbiont, number = Inf, p.value = 0.05) %>% filter(Annotation %>% str_detect("[A|a]mmonium"))
fit.cont2symbiont_ammonium
...
####
# Data feed for heat map, change as required..
heatmap.data <- fit.cont2symbiont_ammonium
#
...
plot_symbiont_gene("SymbC1.scaffold2730.1.m1")  
...
# Gerneral adaptations of respective strains. Take this table for GO analysis with MWU/Fisher script. 
symbiont_SS8_intercept_VS_all <- topTable(fit.cont1symbiont, n=Inf) %>% write.table(, file="symbiont_SS8_intercept_VS_all_topTable.csv", sep="\t", quote=F)

# Specific pairwise comparisons. What separates SS8 from respective strains?
library(openxlsx)
SampleGroup<-"Pairwise-Symbiont-SS8_VS_respec_strains"
Title <- paste(SampleGroup,"DGE-Table")
FileName <- paste(Title,".xlsx")
limma.resA <- topTable(fit.cont1symbiont,coef="SS8.vs.WT10",sort.by="p",n="Inf")
limma.resB <- topTable(fit.cont1symbiont,coef="SS8.vs.SS3",sort.by="p",n="Inf")
limma.resC <- topTable(fit.cont1symbiont,coef="SS8.vs.SS3",sort.by="p",n="Inf")
...
# Gerneral adaptations of respective strains. Take this table for GO analysis with MWU/Fisher script. 
symbiont_WT10_intercept_VS_all <- topTable(fit.cont2symbiont, n=Inf) %>% write.table(, file="symbiont_WT10_intercept_VS_all_topTable.csv", sep="\t", quote=F)

# USE THESE FOR INDIVIDUAL GENE COMPARISONS IN REVIGO
symbiont_strains_8_up_VS_WT10 <- filter(genes_sign_WT10_Intercept, StrainStrain3 == 0 | StrainStrain3 == -1, StrainStrain5 == 0 | StrainStrain5 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
symbiont_strains_8_down_VS_WT10 <- filter(genes_sign_WT10_Intercept, StrainStrain3 == 0 | StrainStrain3 == 1, StrainStrain5 == 0 | StrainStrain5 == 1, StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
symbiont_strains_8_ALL_VS_WT10 <- filter(genes_sign_WT10_Intercept, StrainStrain8 == 1 | StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
write.xlsx(symbiont_strains_8_up_VS_WT10, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="SS_8_vs_WT10_unique_up", append=TRUE, row.names=FALSE)
#
write.xlsx(symbiont_strains_8_down_VS_WT10, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="SS_8_vs_WT10_unique_down", append=TRUE, row.names=FALSE)  
#
write.xlsx(symbiont_strains_8_ALL_VS_WT10, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="symbiont_strains_8_ALL_VS_WT10", append=TRUE, row.names=FALSE) 
...
# Gerneral adaptations of respective strains. Take this table for GO analysis with MWU/Fisher script. 
symbiont_SS3_intercept_VS_all <- topTable(fit.cont3symbiont, n=Inf) %>% write.table(, file="symbiont_SS3_intercept_VS_all_topTable.csv", sep="\t", quote=F)

symbiont_strains_8_up_VS_SS3 <- filter(genes_sign_SS3_Intercept, StrainStrain10 == 0 | StrainStrain10 == -1, StrainStrain5 == 0 | StrainStrain5 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
symbiont_strains_8_down_VS_SS3 <- filter(genes_sign_SS3_Intercept, StrainStrain10 == 0 | StrainStrain10 == 1, StrainStrain5 == 0 | StrainStrain5 == 1, StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
symbiont_strains_8_ALL_VS_SS3 <- filter(genes_sign_SS3_Intercept, StrainStrain8 == 1 | StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
write.xlsx(symbiont_strains_8_up_VS_SS3, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS3_unique_up", append=TRUE, row.names=FALSE)
#
write.xlsx(symbiont_strains_8_down_VS_SS3, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS3_unique_down", append=TRUE, row.names=FALSE)  
#
write.xlsx(symbiont_strains_8_ALL_VS_SS3, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="symbiont_strains_8_ALL_VS_SS3", append=TRUE, row.names=FALSE)  




# Gerneral adaptations of respective strains. Take this table for GO analysis with MWU/Fisher script. 
symbiont_SS5_intercept_VS_all <- topTable(fit.cont4symbiont, n=Inf) %>% write.table(, file="symbiont_SS5_intercept_VS_all_topTable.csv", sep="\t", quote=F)

symbiont_strains_8_up_VS_SS5 <- filter(genes_sign_SS5_Intercept, StrainStrain10 == 0 | StrainStrain10 == -1, StrainStrain3 == 0 | StrainStrain3 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
symbiont_strains_8_up_VS_SS5 <- filter(genes_sign_SS5_Intercept, StrainStrain10 == 0 | StrainStrain10 == -1, StrainStrain3 == 0 | StrainStrain3 == -1, StrainStrain8 == 1) %>% .[order(.$Annotation),]
#
symbiont_strains_8_ALL_VS_SS5 <- filter(genes_sign_SS5_Intercept, StrainStrain8 == 1 | StrainStrain8 == -1) %>% .[order(.$Annotation),]
#
write.xlsx(symbiont_strains_8_up_VS_SS5, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS5_unique_up", append=TRUE, row.names=FALSE)
#
write.xlsx(symbiont_strains_8_down_VS_SS5, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="SS_8_vs_SS5_unique_down", append=TRUE, row.names=FALSE)
#
write.xlsx(symbiont_strains_8_ALL_VS_SS5, file="SS8_symbiont_DGE_expression_list.xlsx", sheetName="symbiont_strains_8_ALL_VS_SS5", append=TRUE, row.names=FALSE)
