...
fit.cont2_host_SS8unique_up <- topTable(fit.cont2_host, number = Inf, p.value = 0.05) %>% filter(gene %in% SS8_unique_up_host$gene) # %>% str_detect(SS_8_unique_up$gene))
SS8_unique_up_host_TopSign <- head(fit.cont2_host_SS8unique_up, 15)
#
...
fit.cont2_host_SS8unique_down <- topTable(fit.cont2_host, number = Inf, p.value = 0.05) %>% filter(gene %in% SS8_unique_down_host$gene) # %>% str_detect(SS_8_unique_up$gene))
SS8_unique_down_host_TopSign <- head(fit.cont2_host_SS8unique_down, 15)
#
fit.cont2_host_SS8unique_TopSign <- rbind(SS8_unique_up_host_TopSign, SS8_unique_down_host_TopSign)
...
fit.cont2_host_SS8unique_TopSign <- rbind(fit.cont2_host_SS8unique_up, fit.cont2_host_SS8unique_down)
library(openxlsx)
SampleGroup<-"fit.cont1_host_SS8unique_TopSign"
Title <- paste(SampleGroup,"SS8")
FileName <- paste(Title,".xlsx")
write.xlsx(fit.cont2_host_SS8unique_TopSign, file=FileName, sep="\t", row.names=TRUE)
...
fit.cont2_symbiont_SS8unique_up <- topTable(fit.cont2_symbiont, number = Inf, p.value = 0.05) %>% filter(gene %in% SS8_unique_up_symbiont$gene) # %>% str_detect(SS_8_unique_up$gene))
SS8_unique_up_symbiont_TopSign <- head(fit.cont2_symbiont_SS8unique_up, 15)
#
...
fit.cont2_symbiont_SS8unique_down <- topTable(fit.cont2_symbiont, number = Inf, p.value = 0.05) %>% filter(gene %in% SS8_unique_down_symbiont$gene) # %>% str_detect(SS_8_unique_up$gene))
SS8_unique_down_symbiont_TopSign <- head(fit.cont2_symbiont_SS8unique_down, 15)
#
fit.cont2_symbiont_SS8unique_TopSign <- rbind(SS8_unique_up_symbiont_TopSign, SS8_unique_down_symbiont_TopSign)
...
# Export Toptable unique genes
fit.cont2_symbiont_SS8unique_TopSign <- rbind(fit.cont2_symbiont_SS8unique_up, fit.cont2_symbiont_SS8unique_down)
library(openxlsx)
SampleGroup<-"fit.cont1_symbiont_SS8unique_TopSign"
Title <- paste(SampleGroup,"SS8")
FileName <- paste(Title,".xlsx")
write.xlsx(fit.cont2_symbiont_SS8unique_TopSign, file=FileName, sep="\t", row.names=TRUE)
